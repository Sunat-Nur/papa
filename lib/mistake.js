class Definer {
    ...
    static general_err2 = "att: there is not data with that params!";
    static general_err3 = "att: file upload error!";

    /** member auth related errors */
    static auth_err1 = "att: no number with that mb_nick!";
    static auth_err2 = "att: your credentials do not match!";
    static auth_err3 = "att: jwt token creation error";
    static auth_err4 = "att: you are not authenticated";
